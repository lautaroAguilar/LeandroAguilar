      ...
      <div className={styles.footerContainer}>
        <div className={styles.miniAbout}>
          ...
          <p>
            ...
            opción de compra para cada caso, soy un representante comercial que
            busca un buen negocio para ambas partes que el propio beneficio
          </p>
        </div>
        <Image
          src={cronistas}
        ...
        <div className={styles.iconsContainer}>
          <Link href={"https://api.whatsapp.com/send?phone=5491123231563"} target="_blank">
            <BsWhatsapp />
          </Link>
          <Link href={"mailto:yorojo2424@gmail.com?subject=Contacto desde la página web de Leandro Aguilar &body=Escriba su mensaje aquí"} target="_blank">
            <HiOutlineMail />
          </Link>
